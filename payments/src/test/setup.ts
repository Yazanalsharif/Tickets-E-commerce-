...
declare global {
  var fakeAuth: (id?: string) => string[];
}

jest.mock("../events/Nats.ts");

process.env.STRIPE_KEY =
  "sk_test_51PaGrKEeVfUrVYrxgzPKcfdhHJIKPQ9u8enYzUoD0p0eUmROdouXNqcLbVCwmT6dzMMKYoYPMp8bZTWtDbuVpAkx00vqRCLQEo";
...
global.fakeAuth = (id?: string): string[] => {
  // user email will be signed
  const user = {
    id: new Types.ObjectId(id) || new Types.ObjectId(),
    email: "test@test.com",
  };
